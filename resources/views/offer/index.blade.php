                                            ...
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    ...
                                                    <a href="{{ route($route['edit'], $notice->id) }}">
                                                        <button class="btn btn-lg btn-link btn-warning">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                    </a>
                                                    <a href="#" onclick="event.preventDefault(); confirmDelete('{{ $notice->id }}');" class="btn btn-danger btn-sm mt-0" style="margin-top: -15px;">
