        ...
        <div class="page-inner">
            <div class="d-flex">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dedicatedplan.index')}}">Dedicated Server Plan</a>
                        </li>
                        <li class="separator">
                          <i class="icon-arrow-right"></i>
                        </li>
                                        ...
                                        @foreach (${$multipostvar} as $notice)
                                            <tr>
				                                ...
				                                @endif
                                                    ...
                                                    <a href="#" onclick="event.preventDefault(); confirmDelete('{{ $notice->id }}');" class="btn btn-danger btn-lg btn-link mt-0" style="margin-top: -15px;">
                                                    ...
                                                    <a href="{{ route($route['duplicate'], $notice->id) }}">
                                                        <button class="btn btn-lg btn-link btn-secondary">
