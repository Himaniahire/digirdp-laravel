                ...
                <div class="card" >
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{ route($route['create']) }}" class="btn btn-primary btn-round ms-auto"><i class="fa fa-plus me-1"></i>New Hosting</a>
                        </div>
                    </div>
                    <!-- Content goes here -->
                    <div class="card-body" >
                                        ...
                                        @foreach (${$multipostvar} as $notice)
                                            <tr>
				                                ...
				                                @endif
                                                    ...
                                                    <a href="#" title="Delete" onclick="event.preventDefault(); confirmDelete('{{ $notice->id }}');" class="btn btn-lg btn-link btn-danger btn-sm mt-0" style="margin-top: -15px;">
