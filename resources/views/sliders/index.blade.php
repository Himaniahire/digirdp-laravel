        ...
        <div class="page-inner">
            <div class="d-flex">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('sliders.index') }}">List</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route($route['create']) }}" class="btn btn-primary btn-round ms-auto"><i
                                        class="fa fa-plus me-1"></i> New Sliders </a>
                            </div>
                        </div>
                        <!-- Content goes here -->
                        <div class="card-body">
                                                ...
                                                <tr>
                                                    @foreach ($fields as $field => $fv)
                                                        ...
                                                        @if (strpos($field, 'image'))
                                                            <td><img src="{{ url($notice->$field) }}" width="100"
                                                                    height="50"></td>
                                                        ...
                                                        @elseif(!strcmp($field, 'slug'))
                                                            <td><a target="_blank"
                                                                    href="{{ url($indexvar['urltomain'] . $notice->$field) }}">GO
                                                                    TO ALBUM</a></td>
                                                        @else
                                                            <td>{{ substr($notice->$field, 0, 20) }}{{ strlen($notice->$field) > 20 ? '...' : '' }}
                                                            </td>
                                                        @endif
                                                    @endforeach
                                                    ...
                                                    {!! Form::close() !!} --}}
                                                        <a href="{{ route($route['show'], $notice->id) }}">
                                                            <button class="btn btn-lg btn-link btn-info ">
                                                        ...
                                                        <a href="#"
                                                            onclick="event.preventDefault(); confirmDelete('{{ $notice->id }}');"
                                                            class="btn btn-danger btn-lg btn-link mt-0" style="margin-top: -15px;">
                                                            <i class="fa fa-trash"></i>
                                                        </a>

                                                        <form id="delete-form-{{ $notice->id }}"
                                                            action="{{ route($route['destroy'], $notice->id) }}"
