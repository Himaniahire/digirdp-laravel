                ...
                <div class="card" >
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">VPS Plan</h4>
                            <a href="{{ route($route['create']) }}" class="btn btn-primary btn-round ms-auto"><i class="fa fa-plus me-1"></i> New VPS Plan</a>
                        </div>
                    </div>
                    <!-- Content goes here -->
                    <div class="card-body" >
                                        ...
                                        @foreach (${$multipostvar} as $notice)
                                            <tr>
				                                ...
				                                @endif
                                                    ...
                                                    <a href="#" title="Delete" onclick="event.preventDefault(); confirmDelete('{{ $notice->id }}');"
